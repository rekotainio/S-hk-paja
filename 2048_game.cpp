...
void vectorToColors(){
  for (int i = 0; i < LED_COUNT; ++i) {
    ...
    if(newBoard[i] == 256){
      colors[LED_COUNT - 1 - i] = rgb_color(145,30,180);
    }
    if(newBoard[i] == 512){
      colors[LED_COUNT - 1 - i] = rgb_color(240,50,230);
    }
    if(newBoard[i] == 1024){
      colors[LED_COUNT - 1 - i] = rgb_color(128,128,128);
    }
    if(newBoard[i] == 2048){
      colors[LED_COUNT - 1 - i] = rgb_color(255,255,255);
    }
